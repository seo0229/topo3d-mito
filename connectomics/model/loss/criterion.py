...
from .topoloss import TopoLossMSE2D, TopoLossMSE3D, TopoLossMSE2D_slice
...
class Criterion(object):
    ...
    loss_dict = {
        ...
        'TopoLossMSE2D': TopoLossMSE2D,
        'TopoLossMSE2D_slice': TopoLossMSE2D_slice,
        'TopoLossMSE3D': TopoLossMSE3D,
        'SoftCLDice': soft_cldice,
    }
